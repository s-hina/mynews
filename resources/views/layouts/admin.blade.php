    ...
    <div id="app">
      ...
      <nav class="navbar navbar-expand-md navbar-dark navbar-laravel">
        <div class="container">
          ...
          <button class="navber-toggler" type="button" data-toggler="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
